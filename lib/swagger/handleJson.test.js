...
var handleJson_1 = tslib_1.__importDefault(require("./handleJson"));
var swaggerApiDefinition = {
    swagger: "2.0",
    basePath: "/",
    info: {
...
describe("Parse Swagger Documentation from Json", function () {
    var toBeParsed = handleJson_1.default(swaggerApiDefinition, "https://demo.api-platform.com");
    test("Properties to be equal", function () {
...
//# sourceMappingURL=handleJson.test.js.map